...
pub fn handle_move(
    ...
    if delete_original {
        ...
        println!(
            "  {} Original page kept (use --delete to remove)",
            "ℹ".yellow()
        );
    }
